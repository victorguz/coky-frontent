...
export class Service<T> {
  ...
  create(entity: T): Promise<any> {
    return this.http.post<any>(`${this.API_URL}/${this.ENTITY_NAME}/create/`, entity).toPromise();
  }
  ...
  delete(id: number): Promise<any> {
    return this.http.delete<any>(`${this.API_URL}/${this.ENTITY_NAME}/delete/${id}`).toPromise();
  }
